...
@WebServlet("/viewConsultarDispo2")
public class viewConsultarDispo2 extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html");
        List<beanDisplay> list= DaoDisplay.getTodosDispositivos();
        request.setAttribute("dispositivo", list);
        RequestDispatcher view = getServletContext().getRequestDispatcher("/UE_consDisp.jsp");
