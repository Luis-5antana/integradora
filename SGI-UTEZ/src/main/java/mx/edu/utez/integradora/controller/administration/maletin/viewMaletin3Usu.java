...
@WebServlet("/viewMaletin3Usu")
public class viewMaletin3Usu extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/UE_regPresMale1.jsp");
