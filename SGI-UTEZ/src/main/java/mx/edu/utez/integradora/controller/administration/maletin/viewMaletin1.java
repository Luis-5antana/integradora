...
//VER MALETINES INTF ADMIN
@WebServlet("/viewMaletin1")
public class viewMaletin1 extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html");
        List<beanMaletin> list= DaoMaletin.getTodosMaletines();
        request.setAttribute("maletine", list);
        RequestDispatcher view = getServletContext().getRequestDispatcher("/AD_consMale.jsp");
