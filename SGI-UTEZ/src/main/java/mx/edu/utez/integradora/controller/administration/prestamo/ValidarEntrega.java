...
@WebServlet(name = "ValidarEntrega", value = "/ValidarEntrega")
public class ValidarEntrega extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/AD_EntPres.jsp");
