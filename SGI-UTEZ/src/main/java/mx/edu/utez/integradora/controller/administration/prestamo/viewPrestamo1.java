...
@WebServlet("/viewPrestamo1")
// Mostrar prestamos para entregar INTERFAZ ADMIN
public class viewPrestamo1 extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/AD_Pres_Act.jsp");
