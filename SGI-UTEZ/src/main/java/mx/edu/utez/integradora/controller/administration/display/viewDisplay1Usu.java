...
@WebServlet("/viewDisplay1Usu")
public class viewDisplay1Usu extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       //solo listar 
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/UE_regPres1.jsp");
