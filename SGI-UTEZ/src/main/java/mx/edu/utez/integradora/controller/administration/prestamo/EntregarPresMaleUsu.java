...
@WebServlet(name = "EntregarPresMaleUsu", value = "/EntregarPresMaleUsu")
public class EntregarPresMaleUsu extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(status>0){
            ...
            mensaje = "false";
            System.out.println("error al entregar prestamo ");
        }
        ...
        request.getRequestDispatcher("/UE_Hist_Pres.jsp").forward(request,response);
    }
