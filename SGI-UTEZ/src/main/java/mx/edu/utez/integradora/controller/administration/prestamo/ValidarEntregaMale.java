...
@WebServlet(name = "ValidarEntregaMaleUsu", value = "/ValidarEntregaMaleUsu")
public class ValidarEntregaMale extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/UE_EntMaleUsu.jsp");
