...
<head>
    ...
    <title>Modificar y Eliminar Dispositivos</title>
...
int contador=1; 
                            for (beanDisplay e : dispositivo) {
                                out.print("<tr><td>" + contador + "</td><td>" + e.getMarca() + "</td><td>" + e.getModelo() + "</td><td>"
                                        ...
                                        + e.getNum_inventario() + "</td><td>" + e.getEstatus() + "</td><td>" + e.getObservaciones() + "</td>" +
                                        "<td><a href='editDisplay?id=" + e.getId_dispositivo() + "'> <button type=\"button\" class=\"btn btn-warning\"><i class=\"fas fa-edit\">" +
                                        "</i></button></i></a><button id='btnDelete2' data-id2='"+e.getId_dispositivo()+ "' type=\"button\" class=\"btn btn-danger\"><i class=\"fas fa-trash-alt\"></i></button></i></td></tr>");
contador++; 
                            }
                        %>
                        </tbody>
        ...
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"
            ...
            crossorigin="anonymous"></script>
        <script src="js/funcionUsuario3.js"></script>
