...
<body>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-light" style="background-color: #345177; ">
                <div class="container-fluid">
                    <a href="UE_regPres.jsp"  style="background-color: #009574;color:#fff;   " class="btn btn-primary btn-lg" role="button" ><i class="fas fa-undo-alt"></i></a>
            ...
            <div class="card border-dark mb-3">
                ...
                <div class="card-body">
                    <fieldset>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>*Maletines disponibles de la categoria <%= prestatario.getTipo_usuario()%>:</label>
                                <select  class="custom-select" name="disp" id="disp" >
                                    <% int contador=0;
                                        ...
                                        if(contador==0){
                                    %>
                                    <option  disabled value="" selected >No hay maletines disponibles, elija otra categoría</option>
                                    <%
                                        }
                                    %>
                                </select>
                ...
                <div class="card-footer text-center">
                    <button type="button" class="btn btn-secondary btn-lg" onclick="valPresMaleUsu()"
    ...
    <script src="js/funRegPresMaleUsu.js"></script>
</body>
