                            ...
                            for (beanPrestamo e : prestamos) {
                                if (e.getEstatus().equals("Activo")){
                                    out.print("<tr><td>" + contador+ "</td><td>" + e.getNombre() + "</td><td>" + e.getMatricula() + "</td><td>"
                                            + e.getCorreo() + "</td><td>" + e.getFecha_inicio() + "</td><td>" + e.getEstatus() + "</td><td> " + e.getId_dispositivo() + "</td><td> <a href='ValidarEntregaUsu?id=" + e.getId_prestamo() + "'> <button type=\"button\"  class=\"btn btn-info\" style=\"background-color:#009574; \"><i class=\"fas fa-edit\"></i><span>Entregar</span></button></a></tr>");
                                    contador++;
                                }
                            }
                        %>
                            ...
                            for (beanPrestamo e : prestamosMale) {
                                if (e.getEstatus().equals("Activo")){
                                    out.print("<tr><td>" + e.getId_prestamo() + "</td><td>" + e.getNombre() + "</td><td>" + e.getMatricula() + "</td><td>"
                                            + e.getCorreo() + "</td><td>" + e.getFecha_inicio() + "</td><td>" + e.getEstatus() + "</td><td> " + e.getId_maletin() + "</td><td> <a href='ValidarEntregaMaleUsu?id=" + e.getId_prestamo() + "'> <button type=\"button\"  class=\"btn btn-info\" style=\"background-color:#009574; \"><i class=\"fas fa-edit\"></i><span>Entregar</span></button></a></tr>");
                                }
                            }
                        %>
                        </tbody>
