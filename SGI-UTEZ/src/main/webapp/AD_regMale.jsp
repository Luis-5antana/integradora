...
<%@ page import="mx.edu.utez.integradora.service.administration.maletin.DaoMaletin" %>
<!-- ORTOGRAFÍA REVISADA -->
<!-- ORTOGRAFÍA REVISADA -->
<!-- ORTOGRAFÍA REVISADA -->
<!-- ORTOGRAFÍA REVISADA -->
...
<%
    List<beanMaletin> uno = DaoMaletin.getTodosMaletines();
    for (int i = 0; i < uno.size(); i++) {
        //Guardo temporalmente al celular en posición i
        beanMaletin temporal = uno.get(i);
        // un arreglo con el tamaño que es el numero de columnas
        String[] fila = new String[3];
        //Asigno valor a cada una de las posiciones de mi arreglo
        fila[0] = temporal.getNum_inventario() + "";
    %>
<input type="hidden" name="num[]" id="num[]" value="<%=fila[0]%>">
<%
    }
%>
<body>
    <div class="wrapper">
        <div class="wrapper">
            ...
            <div class="card border-dark mb-3">
                <div id="maletin" class="card-header" style="background-color: #345177;color:#fff ">
                   Regristar maletín
                </div>
                <div class="card-body">
                  <fieldset>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="num_inventario" name="num_inventario" placeholder="Núm Inventario" >
                             
                            </div>
                            <div class="form-group col-md-6">
                                <label >*Estatus del maletín:</label>
                                <select class="custom-select" id="estatus1" name="estatus" >
                                ...
                                <div class="form-group col-md-6">
                                    <label>*Categoría del maletín:</label>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="descripcion" name="descripción" placeholder="Descripcion del maletin">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="observacion1" name="observacion" rows="3">
                          </div>
                           </div>
                <div class="card-footer text-center">
                    <input type="hidden" value="registrar" name="accion">
                    <button type="button" class="btn btn-secondary btn-lg" onclick="valMale()"
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="js/functionRegMale.js"> </script>
