...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-light" style="background-color: #345177">
            <div class="container-fluid">
                <a href="viewPrestamo1"  style="background-color: #009574;color:#fff;   " class="btn btn-primary btn-lg" role="button" ><i class="fas fa-undo-alt"></i></a>
        ...
        <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <fieldset>
                    <input type="hidden" id="disp" name="disp" value="<%= Prestamoe.getId_maletin() %>">
                    <div class="form-group ">
                        <input type="hidden" id="id" name="id" value="<%= Prestamoe.getId_prestamo() %>">
                        <input type="hidden" id="disp_estatus" name="disp_estatus"  value="Disponible">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-lg" onclick="valEntPresMale()"
    ...
    <script
            ...
            crossorigin="anonymous"
    ></script>
                <script src="js/funcEntPresMale.js"></script>
</body>
</html>
<%
    }else{
