                    ...
                    <%
                        ...
                        for (beanPerson e : usuario) {
                            out.print("<tr><td>" + contador +
                                    ...
                                    "</td><td>" + e.getTipo_usuario() + "</td><td><a href='EditPerson?id=" + e.getId() + "'> <button type=\"button\" class=\"btn btn-warning\"><i class=\"fas fa-edit\"></i></button></i></a>" +
                                    "<button id='btnDelete' data-id='"+e.getId()+"' type=\"button\" class=\"btn btn-danger\"><i class=\"fas fa-trash-alt\"></i></button></i></td></tr>");
contador++; 
                        }
                    %>
                    </tbody
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
        <script src="js/funcionUsuario1.js" ></script>
