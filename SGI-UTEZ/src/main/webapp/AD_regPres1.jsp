...
<body>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-light" style="background-color: #345177; ">
                <div class="container-fluid">
                    <a href="AD_regPres.jsp"  style="background-color: #009574;color:#fff;   " class="btn btn-primary btn-lg" role="button" ><i class="fas fa-undo-alt"></i></a>
            ...
            <div class="card border-dark mb-3">
                ...
                <div class="card-footer text-center">
                    <button type="button" class="btn btn-secondary btn-lg" onclick="valRegPres()"
    ...
    <!-- JS -->
    <script src="js/functionvalRegPres.js"></script>
    <!-- Popper.JS -->
